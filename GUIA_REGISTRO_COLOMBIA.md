...
Debes registrar **CADA base de datos**. Para Basileia:

**Base de Datos 1: Usuarios/Pacientes**
```
Nombre: Base de Datos de Pacientes Basileia
...
```
Nombre: Base de Datos de Profesionales de Salud Basileia
...
- **Telemedicina (como Basileia):** Requiere registro
...
- Datos de la plataforma (Basileia)
- NIT empresa
- Servicios ofrecidos
...
```html
[ ] Autorizo a Basileia el tratamiento de mis datos personales
...
```
1. Recepción de solicitud (Email: privacidad@Basileia.com)
...
3. **Configurar emails corporativos:**
   - [ ] privacidad@Basileia.com (datos personales)
   - [ ] legal@Basileia.com (asuntos legales)
   - [ ] soporte@Basileia.com (usuarios)
