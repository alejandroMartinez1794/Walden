                ...
                <div className="p-10 md:p-14 space-y-8 text-justify leading-relaxed text-sm md:text-[15px] text-slate-800 print:p-0">
                    ...
                    <div className="space-y-6 mt-6">
                        ...
                        <section>
                            ...
                            <p className="mt-2">
                                <strong>Compromiso Terapéutico y Alcance (Obligación de Medios):</strong> En PsicoNepsis, nuestro compromiso ético y profesional es brindarle una atención de <strong>máxima calidad, calidez y rigor científico</strong>. Pondremos a su disposición toda nuestra experiencia y las mejores prácticas clínicas ("lex artis") para promover su bienestar. Entendemos la terapia como un trabajo en equipo: nosotros aportamos la guía experta y usted su participación activa. Por esta razón, y conforme a la ley, si bien garantizamos nuestra total dedicación y metodología, los resultados finales se construyen conjuntamente y dependen de múltiples factores, no pudiendo preestablecerse como garantías infalibles o mecánicas.
                            </p>
                        </section>
