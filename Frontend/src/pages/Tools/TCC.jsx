...
const TCC = () => {
  return (
    <>
      <ClinicalSeoHead
        title="Herramientas de Terapia Cognitivo-Conductual | Basileia"
        description="Herramientas psicoeducativas de TCC para uso responsable. Esta página se mantiene no indexable por contener recursos clínicos sensibles."
        canonicalPath="/herramientas-tcc"
        noIndex
      />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Link to="/psychology/assessments/cbt/suds" className="block">
              <div className="bg-white rounded-lg shadow hover:shadow-md transition-shadow duration-200 p-6 border border-gray-200">
                ...
                <p className="text-gray-600 text-sm">
                  Mide y monitorea niveles de ansiedad en situaciones específicas
                </p>
              </div>
            </Link>
