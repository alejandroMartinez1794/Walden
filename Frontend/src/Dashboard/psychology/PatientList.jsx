      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-3">
          <Link 
            ...
            className="bg-white border border-primaryColor text-primaryColor px-6 py-3 rounded-lg hover:bg-blue-50 transition-all flex items-center gap-2 font-medium"
          >
          ...
          <Link 
            ...
            className="bg-primaryColor text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-all flex items-center gap-2 font-medium"
          >
